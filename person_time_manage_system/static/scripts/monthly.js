...
function main(){
    ...
    $.get(restful_url).done(function (data){
        ...
        init1("echart1", data.this_month.word_cloud)
        init2("echart3", data.this_month.ability_redar)
        init3("echart7", data.this_month.living_time)
        init4("echart5", data.this_month)


        init1("echart2", data.last_month.word_cloud)
        init2("echart4", data.last_month.ability_redar)

        init3("echart8", data.last_month.living_time)
        init4("echart6", data.last_month)
