...
function init6(){
    var date_now = "2019.1.16"
     $.get("/all_category_every_day_hours/"+date_now).done(function (data) {
...
function init7(){
    ...
    $.get("/missing_period/"+date_now).done(function (data) {
            var tbody =document.getElementById('missing_info');
            var info = data;
